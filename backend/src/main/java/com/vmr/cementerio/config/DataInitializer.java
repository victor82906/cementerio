...
//         admin.setDireccion("CALLE");
//         admin.setTelefono("622706214");
//         usuarioRepository.save(admin);

//         Ciudadano ciudadano = new Ciudadano();
//         ciudadano.setNombre("Ciudadano");
//         ciudadano.setEmail("ciudadano@ciudadano.com");
//         ciudadano.setContrasena(passwordEncoder.encode("12345678"));
//         ciudadano.setRol(rolCiudadano);
//         ciudadano.setDni("11111111H");
//         ciudadano.setDireccion("CALLE CIUDADANO");
//         ciudadano.setTelefono("622706215");
//         ciudadano.setApellidos("ciudadano");
//         ciudadanoRepository.save(ciudadano);

//         Ayuntamiento ayto = new Ayuntamiento();
//         ayto.setNombre("Ayuntamiento Cartagena");
//         ayto.setEmail("ayuntamiento@ayuntamiento.com");
//         ayto.setContrasena(passwordEncoder.encode("12345678"));
//         ayto.setRol(rolAyuntamiento);
//         ayto.setCodigo("123456");
//         ayto.setDireccion("CALLE CIUDADANO");
//         ayto.setTelefono("622706215");
